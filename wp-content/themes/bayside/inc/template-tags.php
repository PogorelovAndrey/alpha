...
function progression_posted_on() {
	printf( __( '<div class="post-meta-bayside"><span class="date-bayside">Posted on <a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a></span><span class="author-bayside"> by <a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></div>', 'progression' ),
